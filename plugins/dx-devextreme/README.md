...
| [devextreme-numberbox](skills/devextreme-numberbox/) | NumberBox: mininum and maximum values, display format, spin buttons, invalid value handling | [Overview](https://js.devexpress.com/Documentation/Guide/UI_Components/NumberBox/Getting_Started_with_NumberBox/) |
...
Skill folders contain the following files and sub-directories:
